...
const StudentRegister = () => {
  ...
  const handleRegister = async (event) => {
    ...
    try {
        ...
        console.log('FormData:', stringify(formData));  // For debugging purposes only

        const response = await axios.post('http://localhost:8182/student/register', formData);
